## Lend Borrow Front End Integration
```
Allow users to deposit, withdraw, lend and borrow using a default solana program
```
...
- [ ] copy idl/bank.json and types/bank.ts and paste it inside components folder
